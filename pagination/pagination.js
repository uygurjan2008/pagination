function pagination(data, pagesize, target1, target2, fn) {
	...
	var dt = [];
		for (var i = 1; i < 500; i++) {
			dt[dt.length] = "<div page=\""+i+"\">" + "<div style=\"float:left;width:30%;\">"
					+ i + "</div>" + "<div style=\"float:left;width:30%;\">"
					+ i + "</div>" + "<div style=\"float:left;width:10%;\">"
					+ i + "</div>"+
					"<div style=\"float:left;width:10%;\">"
					+ "<input type=\"checkbox\">aa" + "</div>"
					+"<div style=\"float:left;width:10%;\">"
					+ "<input type=\"button\" value=\"update\" class=\"update\">" + "</div>"
					+"<div style=\"float:left;width:10%;\">"
		...
		pagination(dt, 20, $(".page"), $(".content"),function(){
			
			
			$(".update").click(function(){
				var parent=$(this).parent().parent();
				//console.log("this:",parent.children(),parent.attr("page"));
				alert("update id="+parent.attr("page"));
			});
			$(".delete").click(function(){
				var parent=$(this).parent().parent();
				//console.log("this:",parent.children(),parent.attr("page"));
				alert("delete id="+parent.attr("page"));
			});
		});
